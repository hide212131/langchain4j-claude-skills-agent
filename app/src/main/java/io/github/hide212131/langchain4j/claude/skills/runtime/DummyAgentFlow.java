...
public final class DummyAgentFlow {
    ...
    public Result run(SkillDocument document, String goal, VisibilityLog log, boolean basicLog, String runId) {
        ...
        log.info(basicLog, runId, document.id(), "plan", "plan.prompt", "Plan を生成しました", "goal=" + (safeGoal.isEmpty() ? "(none)" : safeGoal), plan);
