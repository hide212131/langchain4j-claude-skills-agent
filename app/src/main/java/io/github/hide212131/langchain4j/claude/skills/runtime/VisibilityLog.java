...
public final class VisibilityLog {
    ...
    public void warn(
            ...
            String output,
            Throwable error) {
        logger.log(Level.WARNING, format(Level.WARNING, runId, skillId, phase, step, message, input, output, error), error);
    }
    ...
    public void error(
            ...
            String output,
            Throwable error) {
        logger.log(Level.SEVERE, format(Level.SEVERE, runId, skillId, phase, step, message, input, output, error), error);
    }
